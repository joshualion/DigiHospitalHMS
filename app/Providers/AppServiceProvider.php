...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(BloodBankLocation::class, BloodBankLocationPolicy::class);
        Gate::policy(BloodComponent::class, BloodComponentPolicy::class);
        Gate::policy(BloodDonation::class, BloodDonationPolicy::class);
        Gate::policy(BloodDonor::class, BloodDonorPolicy::class);
        Gate::policy(CashierShift::class, CashierShiftPolicy::class);
        Gate::policy(Department::class, DepartmentPolicy::class);
        Gate::policy(EmarSchedule::class, EmarSchedulePolicy::class);
        ...
        Gate::policy(InpatientChart::class, InpatientChartPolicy::class);
