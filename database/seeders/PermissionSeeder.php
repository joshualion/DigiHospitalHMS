...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            'blood-bank.view',
            'blood-bank.catalogue.manage',
            'blood-bank.donors.manage',
            'blood-bank.screening.manage',
            'blood-bank.collections.manage',
            'blood-bank.testing.manage',
            'blood-bank.testing.verify',
            'blood-bank.components.manage',
            'blood-bank.components.release',
            'blood-bank.amend',
            'blood-bank.requests.view',
            'blood-bank.requests.order',
            'blood-bank.requests.manage',
            'blood-bank.specimens.manage',
            'blood-bank.compatibility.enter',
            'blood-bank.compatibility.authorize',
        ...
        Role::whereIn('name', ['doctor', 'nurse'])->get()->each(fn (Role $role) => $role->syncPermissions([
            ...
            'inpatient.handover',
            'inpatient.orders',
            'emar.view', 'emar.administer', 'emar.amend',
        ...
        Role::where('name', 'blood-bank-staff')->first()?->syncPermissions([
            'hospital.view',
            'facilities.view',
            'departments.view',
            'patients.view',
