...
- Authenticated browser smoke for `/admin/public-website/pages/10` requires local admin credentials or approval to create/reset a local smoke admin. Feature-level editor tests pass, but a real browser login was not completed without credentials.
