...
import { Activity, Building2, ClipboardList, FileClock, FlaskConical, Gauge, Menu, PanelLeftClose, PanelLeftOpen, ScanLine, Settings, ShieldCheck, Stethoscope, UserCog, UsersRound, WalletCards, X } from '@lucide/vue';
