...
Route::middleware(['auth', 'role:superadmin|admin|hospital-admin|receptionist|doctor|nurse|cashier|accountant|laboratory-scientist|radiology-staff|pharmacist|storekeeper|blood-bank-staff'])
    ...
    ->group(function () {
        ...
        Route::post('blood-bank/requests', [BloodBankController::class, 'storeRequest'])->name('admin.blood-bank.requests.store');
        Route::get('blood-bank/requests/{bloodRequest}', [BloodBankController::class, 'showRequest'])->name('admin.blood-bank.requests.show');
        Route::patch('blood-bank/requests/{bloodRequest}', [BloodBankController::class, 'requestAction'])->name('admin.blood-bank.requests.action');
        Route::post('blood-bank/requests/{bloodRequest}/specimens', [BloodBankController::class, 'collectPatientSpecimen'])->name('admin.blood-bank.requests.specimens.store');
        Route::post('blood-bank/requests/{bloodRequest}/patient-groups', [BloodBankController::class, 'enterPatientGroup'])->name('admin.blood-bank.requests.patient-groups.store');
        Route::post('blood-bank/patient-groups/{group}/verify', [BloodBankController::class, 'verifyPatientGroup'])->name('admin.blood-bank.patient-groups.verify');
        Route::post('blood-bank/requests/{bloodRequest}/compatibility-tests', [BloodBankController::class, 'enterCompatibility'])->name('admin.blood-bank.requests.compatibility.store');
        Route::post('blood-bank/compatibility-tests/{test}/authorize', [BloodBankController::class, 'authorizeCompatibility'])->name('admin.blood-bank.compatibility.authorize');
        Route::post('blood-bank/requests/{bloodRequest}/reservations', [BloodBankController::class, 'reserveComponent'])->name('admin.blood-bank.requests.reservations.store');
        Route::post('blood-bank/requests/{bloodRequest}/issues', [BloodBankController::class, 'issueComponent'])->name('admin.blood-bank.requests.issues.store');
        Route::post('blood-bank/issues/{issue}/return', [BloodBankController::class, 'returnIssue'])->name('admin.blood-bank.issues.return');
